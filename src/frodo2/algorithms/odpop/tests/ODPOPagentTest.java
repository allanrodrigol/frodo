 ...
 *
 */
public class ODPOPagentTest < V extends Addable<V>, U extends Addable<U> > extends TestCase implements IncomingMsgPolicyInterface<MessageType> {
	 ...
	 */
	public ODPOPagentTest(String string, boolean useCentralMailer, boolean useDelay, MessageType startMsgType, Class<V> domClass, Class<U> utilClass) {
		super (string);
	...
	public static TestSuite suite () {
		...
		tmp.addTest(new RepeatedTest (new ODPOPagentTest<AddableInteger, AddableInteger> ("testRandomSharedMemory", false, false, new MessageType ("START NOW!"), AddableInteger.class, AddableInteger.class), 500));
		suite.addTest(tmp);
