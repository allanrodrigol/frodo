...
implements StatsReporterWithConvergence<Val> {
	...
	public static final MessageType UTIL_MSG = UTILpropagation.UTIL_MSG;
	
	/** The type of the UTIL message with domain information */
	public static final MessageType UTIL_MSG_DOM = UTILpropagation.UTIL_MSG_DOM;
	
	/** The type of the UTIL message with variable IDs*/
	public static final MessageType UTIL_MSG_VARS = UTILpropagation.UTIL_MSG_VARS;
	
	/** The type of the UTIL message with variable IDs and domain information */
	public static final MessageType UTIL_MSG_DOM_VARS = UTILpropagation.UTIL_MSG_DOM_VARS;

	/** The type of the ASK message*/
	public static final MessageType ASK_MSG = UTILpropagation.ASK_MSG;

	/** The type of the DONE message*/
	public static final MessageType DONE_MSG	= UTILpropagation.DONE_MSG;
	...
	public static final MessageType CONV_STATS_MSG_TYPE = ASODPOP.CONV_STATS_MSG_TYPE;
	...
	public static final MessageType OUTPUT_MSG_TYPE = ASODPOP.OUTPUT_MSG_TYPE;
